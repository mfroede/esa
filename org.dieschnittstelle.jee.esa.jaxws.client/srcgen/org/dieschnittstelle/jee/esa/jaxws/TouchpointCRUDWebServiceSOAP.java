 ...
 * 2013-09-22T15:13:29.980+02:00
 * Generated source version: 2.4.6
 * 
 */
@WebService(targetNamespace = "http://dieschnittstelle.org/jee/esa/jaxws", name = "TouchpointCRUDWebServiceSOAP")
@XmlSeeAlso({org.dieschnittstelle.jee.esa.crm.model.ObjectFactory.class, ObjectFactory.class})
...
public interface TouchpointCRUDWebServiceSOAP {
    ...
    @WebMethod
    public org.dieschnittstelle.jee.esa.crm.model.AbstractTouchpoint updateTouchpoint(
        @WebParam(partName = "updateTouchpoint", name = "updateTouchpoint", targetNamespace = "http://dieschnittstelle.org/jee/esa/jaxws")
        org.dieschnittstelle.jee.esa.crm.model.AbstractTouchpoint updateTouchpoint
    );
    ...
    @WebMethod
    public org.dieschnittstelle.jee.esa.crm.model.AbstractTouchpoint createTouchpoint(
        @WebParam(partName = "createTouchpoint", name = "createTouchpoint", targetNamespace = "http://dieschnittstelle.org/jee/esa/jaxws")
        org.dieschnittstelle.jee.esa.crm.model.AbstractTouchpoint createTouchpoint
    );
    ...
    @WebMethod
    public org.dieschnittstelle.jee.esa.crm.model.AbstractTouchpointArray readAllTouchpoints();
}
