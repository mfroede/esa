...
public class NavigationActivity extends AbstractActivityDefaultImpl<NavigationPlace> implements NavigationView.Presenter {
   ...
   @Inject
   public NavigationActivity(final NavigationView view, final EventBus eventBus, PlaceController placeController) {
      this.view = view;
