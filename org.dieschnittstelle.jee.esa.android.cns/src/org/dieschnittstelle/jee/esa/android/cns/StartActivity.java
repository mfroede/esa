package org.dieschnittstelle.jee.esa.android.cns;
...
public class StartActivity extends Activity {
    ...
    */
   static final String LOG_TAG = StartActivity.class.getName();
   ...
   private SharedPreferences getGCMPreferences(Context context) {
      return getSharedPreferences(StartActivity.class.getSimpleName(), Context.MODE_PRIVATE);
   }
   ...
   private void registerWithServer() {
      ...
      String url = baseUrl + getRegistrationId(StartActivity.this);
      AQuery aq = new AQuery(StartActivity.this);
      aq.ajax(url, String.class, new AjaxCallback<String>() {
         ...
         public void callback(String url, String s, AjaxStatus status) {
            if (s != null) {
               ...
               Toast.makeText(StartActivity.this, status.toString(), Toast.LENGTH_LONG).show();
            }
         }
